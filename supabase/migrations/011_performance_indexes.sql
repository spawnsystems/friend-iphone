...
-- Todos son para no bloquear la DB en producción
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_reparaciones_fecha_ingreso
  ON reparaciones(fecha_ingreso DESC);

-- Dashboard combinado: estado + fecha (la query más frecuente)
CREATE INDEX IF NOT EXISTS idx_reparaciones_estado_fecha
  ON reparaciones(estado, fecha_ingreso DESC);

-- Detalle de reparación por cliente
CREATE INDEX IF NOT EXISTS idx_reparaciones_cliente_id
